...
- [SE Agent (9)](#se-agent)
- [Code Generation (9)](#code-generation)
- [Activity (5)](#activity)
...
- [Chronos](https://github.com/Kodezi/Chronos) ⭐4933 — Debugging-first LM claiming SOTA on SWE-bench Lite with 80.33% resolve rate. 🏆
...
- [multi-agent-coding-system](https://github.com/Danau5tin/multi-agent-coding-system) ⭐1380 — Multi-agent coding system reaching #13 on TerminalBench leaderboard. 🤝 🏆
...
- [Julia-LLM-Leaderboard](https://github.com/svilupp/Julia-LLM-Leaderboard) ⭐86 — Leaderboard comparing AI models on Julia code generation with automated evals. 🏆
...
- [claude-agent-leaderboard](https://github.com/kubony/claude-agent-leaderboard) ⭐13 — Leaderboard tracking agent/skill execution contributions in Claude Code.
...
- [showdown](https://github.com/verseles/showdown) ⭐11 — Aggregates LLM rankings across multiple benchmarks with open community data. 🏆
