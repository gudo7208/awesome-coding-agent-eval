...
- [Chronos](https://github.com/Kodezi/Chronos) ⭐4919 — Debugging-first LM claiming SOTA on SWE-bench Lite with 80.33% resolve rate. 🏆
...
- [multi-agent-coding-system](https://github.com/Danau5tin/multi-agent-coding-system) ⭐1386 — Multi-agent coding system reaching #13 on TerminalBench leaderboard. 🤝 🏆
