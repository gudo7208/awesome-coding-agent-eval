...
- [AgentEval](https://github.com/AgentEvalHQ/AgentEval) ⭐96 — AgentEval.
...
- [aira-dojo](https://github.com/facebookresearch/aira-dojo) ⭐145 — AI research agent development and evaluation framework by Facebook Research.
- [any-agent](https://github.com/mozilla-ai/any-agent) ⭐1168 — Unified interface to build agents across frameworks with tracing and scoring.
...
- [awslabs/agent-evaluation](https://github.com/awslabs/agent-evaluation) ⭐362 — awslabs/agent-evaluation.
...
- [bigcode-evaluation-harness](https://github.com/bigcode-project/bigcode-evaluation-harness) ⭐1045 — Evaluates code generation models on HumanEval, MBPP, and other benchmarks.
...
- [claw-eval](https://github.com/claw-eval/claw-eval) ⭐569 — claw-eval.
- [codex-long-running-harness](https://github.com/LongWeihan/codex-long-running-harness) ⭐17 — codex-long-running-harness. 📅
- [collaborative-gym](https://github.com/SALT-NLP/collaborative-gym) ⭐131 — Framework for building and evaluating human-AI collaborative agents. 🤝
- [evalmonkey](https://github.com/Corbell-AI/evalmonkey) ⭐31 — CLI eval harness for AI coding agents with benchmark and chaos fault injection.
- [evals](https://github.com/strands-agents/evals) ⭐125 — Evaluation framework for AI agents and LLM apps with automated agentic testing. 🐍

### G–L

- [harbor](https://github.com/harbor-framework/harbor) ⭐1984 — Runs AI agent evals and RL environments with terminal-based benchmarking.
...
- [intellagent](https://github.com/plurai-ai/intellagent) ⭐1230 — intellagent.
- [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐12599 — General-purpose LLM evaluation framework supporting hundreds of benchmarks.
...
- [OpenAI Evals](https://github.com/openai/evals) ⭐18485 — OpenAI Evals.
...
- [OpenHands Eval Harness](https://github.com/All-Hands-AI/OpenHands) ⭐73912 — Built-in eval framework for OpenHands supporting SWE-bench and more, 30x faster.
...
- [smolagents](https://github.com/huggingface/smolagents) ⭐27361 — Hugging Face lightweight framework for building and running LLM-powered agents. 🤝 🐍
- [squeez](https://github.com/KRLabsOrg/squeez) ⭐17 — Compresses verbose tool outputs for coding agents via LoRA fine-tuning.
- [SWE Agent](https://github.com/princeton-nlp/swe-agent) ⭐19236 — SWE Agent.
...
- [Test-Agent](https://github.com/codefuse-ai/Test-Agent) ⭐695 — LLM-powered software testing agent for industrial use cases.
- [token-savior](https://github.com/Mibayy/token-savior) ⭐869 — token-savior.
- [ts-bench](https://github.com/laiso/ts-bench) ⭐234 — CLI benchmark tool for evaluating AI coding agents on TypeScript workloads. 🔷
- [upskill](https://github.com/huggingface/upskill) ⭐624 — Generates and evaluates coding skills of agents like Claude Code and Codex.
...
- [agent-safehouse](https://github.com/eugene1g/agent-safehouse) ⭐1773 — Sandbox for local AI agents with scoped read/write filesystem access.
- [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐2226 — Kubernetes-based sandbox runtime for isolated stateful AI agent workloads.
...
- [arrakis](https://github.com/abshkbh/arrakis) ⭐812 — arrakis.
- [artifact-fs](https://github.com/cloudflare/artifact-fs) ⭐801 — FUSE filesystem driver for lazy-mounting large git repos in agent sandboxes.
...
- [boxlite](https://github.com/boxlite-ai/boxlite) ⭐2068 — Embeddable sandbox for AI agents with snapshots, state and hardware isolation.
...
- [coderunner](https://github.com/instavm/coderunner) ⭐825 — Local isolated sandbox for AI agents to run code safely in containers.
- [cua](https://github.com/trycua/cua) ⭐16886 — Sandbox infra for computer-use agents with macOS/Linux/Windows VMs and SDK.
- [CubeSandbox](https://github.com/TencentCloud/CubeSandbox) ⭐5710 — Sandbox for secure AI agent code execution with instant concurrent containers. 🦀
...
- [E2B](https://github.com/e2b-dev/E2B) ⭐12223 — Sandbox for secure AI agent code execution with Firecracker microVMs.
...
- [gondolin](https://github.com/earendil-works/gondolin) ⭐1203 — Experimental agent sandbox using Linux microVMs with TypeScript control plane. 🔷
- [judge0](https://github.com/judge0/judge0) ⭐4174 — Open-source sandboxed code execution system supporting 60+ languages. 🌐
...
- [microsandbox](https://github.com/superradcompany/microsandbox) ⭐6128 — microsandbox. 🔒
- [mithril](https://github.com/radimsem/mithril) ⭐14 — Trustless MCP server with sandboxed execution tools for AI coding agents.
...
- [nono](https://github.com/always-further/nono) ⭐2410 — Zero-config AI agent sandbox with capability-model-based multiplexed isolation.
...
- [OpenSandbox](https://github.com/alibaba/OpenSandbox) ⭐10673 — OpenSandbox.
- [pctx](https://github.com/portofcontext/pctx) ⭐253 — Execution layer running agentic tool calls in secure sandboxes for AI workflows.
...
- [sandbox](https://github.com/agent-infra/sandbox) ⭐4720 — sandbox.
- [sandbox-agent](https://github.com/rivet-dev/sandbox-agent) ⭐1378 — Run coding agents in sandboxed environments with HTTP control for evaluation.
- [sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) ⭐1023 — SDK for running sandboxed code environments on Cloudflare's edge network.
...
- [secure-exec](https://github.com/rivet-dev/secure-exec) ⭐870 — secure-exec.
- [skypilot-code-sandbox](https://github.com/alex000kim/skypilot-code-sandbox) ⭐17 — skypilot-code-sandbox.
- [SmolVM](https://github.com/CelestoAI/SmolVM) ⭐546 — Lightweight open-source VM sandbox for AI agent code execution and browser use.
...
- [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐502 — SWE-ReX.
...
- [the-agent-sandbox-taxonomy](https://github.com/kajogo777/the-agent-sandbox-taxonomy) ⭐68 — Taxonomy and scoring framework for AI agent sandboxes with 7 defense layers.
- [vibe](https://github.com/lynaghk/vibe) ⭐908 — vibe. 🦀
- [vibekit](https://github.com/superagent-ai/vibekit) ⭐1790 — vibekit. 🤝
- [wuying-agentbay-sdk](https://github.com/agentbay-ai/wuying-agentbay-sdk) ⭐1118 — Cloud sandbox environment SDK built for AI agents.
- [zeroboot](https://github.com/zerobootdev/zeroboot) ⭐2331 — zeroboot.

<a id="observability"></a>
## Observability

- [agentevals](https://github.com/agentevals-dev/agentevals) ⭐130 — Evaluates AI agents via OpenTelemetry traces in a framework-agnostic way.
...
- [Langfuse](https://github.com/langfuse/langfuse) ⭐27364 — Open-source LLM observability platform with tracing, spans, and scoring.
- [Observal](https://github.com/BlazeUp-AI/Observal) ⭐1143 — Observal.
- [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst) ⭐16163 — Python SDK for AI agent observability, tracing, monitoring and evaluation. 🤝
- [RepoAgent](https://github.com/OpenBMB/RepoAgent) ⭐964 — LLM-powered framework for automated repository documentation generation.
...
- [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐21341 — Tests and evaluates LLM outputs with prompt comparison and auto-scoring.
