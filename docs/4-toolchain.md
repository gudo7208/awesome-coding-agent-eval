...
- [AgentEval](https://github.com/AgentEvalHQ/AgentEval) ⭐114 — Provide a harness for evaluating AI agent task performance.
- [aider-swe-bench](https://github.com/Aider-AI/aider-swe-bench) ⭐84 — Harness for running and evaluating Aider on SWE-Bench benchmark.
- [aira-dojo](https://github.com/facebookresearch/aira-dojo) ⭐148 — AI research agent development and evaluation framework by Facebook Research.
- [any-agent](https://github.com/mozilla-ai/any-agent) ⭐1171 — Unified interface to build agents across frameworks with tracing and scoring.
...
- [awslabs/agent-evaluation](https://github.com/awslabs/agent-evaluation) ⭐364 — Provide an AWS framework for evaluating AI agent performance.
...
- [bigcode-evaluation-harness](https://github.com/bigcode-project/bigcode-evaluation-harness) ⭐1047 — Evaluates code generation models on HumanEval, MBPP, and other benchmarks.
...
- [CATArena](https://github.com/AGI-Eval-Official/CATArena) ⭐66 — Tournament platform for code agents via iterative competitive peer learning.
- [claw-eval](https://github.com/claw-eval/claw-eval) ⭐627 — Provide an evaluation harness for coding LLM agents.
- [codex-long-running-harness](https://github.com/LongWeihan/codex-long-running-harness) ⭐17 — Provide a harness for long-duration coding agent evaluations. 📅
- [collaborative-gym](https://github.com/SALT-NLP/collaborative-gym) ⭐133 — Framework for building and evaluating human-AI collaborative agents. 🤝
- [evalmonkey](https://github.com/Corbell-AI/evalmonkey) ⭐36 — CLI eval harness for AI coding agents with benchmark and chaos fault injection.
- [evals](https://github.com/strands-agents/evals) ⭐131 — Evaluation framework for AI agents and LLM apps with automated agentic testing. 🐍

### G–L

- [harbor](https://github.com/harbor-framework/harbor) ⭐2227 — Runs AI agent evals and RL environments with terminal-based benchmarking.
...
- [intellagent](https://github.com/plurai-ai/intellagent) ⭐1230 — Provide an intelligent evaluation harness for AI agents.
- [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐12764 — General-purpose LLM evaluation framework supporting hundreds of benchmarks.
...
- [OpenAI Evals](https://github.com/openai/evals) ⭐18577 — Provide a framework for evaluating LLM model outputs.
...
- [OpenHands Eval Harness](https://github.com/All-Hands-AI/OpenHands) ⭐75524 — Built-in eval framework for OpenHands supporting SWE-bench and more, 30x faster.
...
- [SanityHarness](https://github.com/lemon07r/SanityHarness) ⭐223 — Provide a sanity-check harness for agent evaluation pipelines. 🌐
- [sb-cli](https://github.com/SWE-bench/sb-cli) ⭐68 — Official SWE-bench CLI tool for running remote evaluation tasks.
...
- [smolagents](https://github.com/huggingface/smolagents) ⭐27627 — Hugging Face lightweight framework for building and running LLM-powered agents. 🤝 🐍
- [squeez](https://github.com/KRLabsOrg/squeez) ⭐17 — Compresses verbose tool outputs for coding agents via LoRA fine-tuning.
- [SWE Agent](https://github.com/princeton-nlp/swe-agent) ⭐19380 — Provide an agent harness for solving software engineering tasks.
...
- [SWE-bench Experiments](https://github.com/SWE-bench/experiments) ⭐265 — Provide experiment tracking for SWE-bench evaluation runs.
- [Test-Agent](https://github.com/codefuse-ai/Test-Agent) ⭐696 — LLM-powered software testing agent for industrial use cases.
- [token-savior](https://github.com/Mibayy/token-savior) ⭐924 — Provide token-efficient optimization for agent evaluation runs.
- [ts-bench](https://github.com/laiso/ts-bench) ⭐234 — CLI benchmark tool for evaluating AI coding agents on TypeScript workloads. 🔷
- [upskill](https://github.com/huggingface/upskill) ⭐664 — Generates and evaluates coding skills of agents like Claude Code and Codex.
...
- [agent-safehouse](https://github.com/eugene1g/agent-safehouse) ⭐1826 — Sandbox for local AI agents with scoped read/write filesystem access.
- [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐2677 — Kubernetes-based sandbox runtime for isolated stateful AI agent workloads.
- [agentbox](https://github.com/Michaelliv/agentbox) ⭐46 — Sandboxed code execution environment for AI agents.
...
- [arrakis](https://github.com/abshkbh/arrakis) ⭐815 — Provide sandboxed execution environments for code evaluation.
- [artifact-fs](https://github.com/cloudflare/artifact-fs) ⭐894 — FUSE filesystem driver for lazy-mounting large git repos in agent sandboxes.
...
- [boxlite](https://github.com/boxlite-ai/boxlite) ⭐2103 — Embeddable sandbox for AI agents with snapshots, state and hardware isolation.
...
- [coderunner](https://github.com/instavm/coderunner) ⭐832 — Local isolated sandbox for AI agents to run code safely in containers.
- [cua](https://github.com/trycua/cua) ⭐17402 — Sandbox infra for computer-use agents with macOS/Linux/Windows VMs and SDK.
- [CubeSandbox](https://github.com/TencentCloud/CubeSandbox) ⭐6032 — Sandbox for secure AI agent code execution with instant concurrent containers. 🦀
...
- [E2B](https://github.com/e2b-dev/E2B) ⭐12425 — Sandbox for secure AI agent code execution with Firecracker microVMs.
- [exec-sandbox](https://github.com/dualeai/exec-sandbox) ⭐27 — Provide a sandboxed environment for secure code execution.
...
- [gondolin](https://github.com/earendil-works/gondolin) ⭐1308 — Experimental agent sandbox using Linux microVMs with TypeScript control plane. 🔷
- [judge0](https://github.com/judge0/judge0) ⭐4197 — Open-source sandboxed code execution system supporting 60+ languages. 🌐
...
- [microsandbox](https://github.com/superradcompany/microsandbox) ⭐6370 — Provide lightweight micro-sandboxes for secure code execution. 🔒
- [mithril](https://github.com/radimsem/mithril) ⭐15 — Trustless MCP server with sandboxed execution tools for AI coding agents.
...
- [nono](https://github.com/always-further/nono) ⭐2545 — Zero-config AI agent sandbox with capability-model-based multiplexed isolation.
...
- [OpenSandbox](https://github.com/alibaba/OpenSandbox) ⭐10905 — Provide an open-source sandbox for secure code execution.
- [pctx](https://github.com/portofcontext/pctx) ⭐258 — Execution layer running agentic tool calls in secure sandboxes for AI workflows.
...
- [sandbox](https://github.com/agent-infra/sandbox) ⭐4872 — Provide a general-purpose sandbox for isolated code execution.
- [sandbox-agent](https://github.com/rivet-dev/sandbox-agent) ⭐1415 — Run coding agents in sandboxed environments with HTTP control for evaluation.
- [sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) ⭐1035 — SDK for running sandboxed code environments on Cloudflare's edge network.
...
- [sandboxer](https://github.com/ammmir/sandboxer) ⭐17 — Forkable code execution sandbox server for LLMs and agents.
- [ScaleBox](https://arxiv.org/abs/2604.29700) — High-fidelity and scalable code verification sandbox for LLMs.
- [secure-exec](https://github.com/rivet-dev/secure-exec) ⭐881 — Provide secure execution sandboxes for untrusted code.
...
- [SmolVM](https://github.com/CelestoAI/SmolVM) ⭐568 — Lightweight open-source VM sandbox for AI agent code execution and browser use.
...
- [SWE-bench-docker](https://github.com/aorwall/SWE-bench-docker) ⭐104 — Dockerized sandbox for running SWE-bench evaluations in isolated containers.
- [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐516 — Provide remote execution sandboxes for SWE-bench evaluation.
...
- [the-agent-sandbox-taxonomy](https://github.com/kajogo777/the-agent-sandbox-taxonomy) ⭐79 — Taxonomy and scoring framework for AI agent sandboxes with 7 defense layers.
- [vibe](https://github.com/lynaghk/vibe) ⭐921 — Provide a sandbox environment for code execution and testing. 🦀
- [vibekit](https://github.com/superagent-ai/vibekit) ⭐1789 — Provide a toolkit for building sandboxed coding environments. 🤝
- [wuying-agentbay-sdk](https://github.com/agentbay-ai/wuying-agentbay-sdk) ⭐1127 — Cloud sandbox environment SDK built for AI agents.
- [zeroboot](https://github.com/zerobootdev/zeroboot) ⭐2354 — Provide zero-setup sandbox bootstrapping for code evaluation.

<a id="observability"></a>
## Observability

- [agentevals](https://github.com/agentevals-dev/agentevals) ⭐133 — Evaluates AI agents via OpenTelemetry traces in a framework-agnostic way.
...
- [Langfuse](https://github.com/langfuse/langfuse) ⭐28288 — Open-source LLM observability platform with tracing, spans, and scoring.
- [Observal](https://github.com/BlazeUp-AI/Observal) ⭐1812 — Provide observability tooling for AI agent evaluation.
- [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst) ⭐16169 — Python SDK for AI agent observability, tracing, monitoring and evaluation. 🤝
- [RepoAgent](https://github.com/OpenBMB/RepoAgent) ⭐978 — LLM-powered framework for automated repository documentation generation.
...
- [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐21758 — Tests and evaluates LLM outputs with prompt comparison and auto-scoring.
- [sage](https://github.com/usetig/sage) ⭐96 — LLM council that reviews and evaluates coding agent actions in real-time. 🤖
