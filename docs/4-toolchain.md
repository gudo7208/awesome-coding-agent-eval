...
- [AgentEval](https://github.com/AgentEvalHQ/AgentEval) ⭐116 — Provide a harness for evaluating AI agent task performance.
...
- [aira-dojo](https://github.com/facebookresearch/aira-dojo) ⭐150 — AI research agent development and evaluation framework by Facebook Research.
- [any-agent](https://github.com/mozilla-ai/any-agent) ⭐1175 — Unified interface to build agents across frameworks with tracing and scoring.
...
- [awslabs/agent-evaluation](https://github.com/awslabs/agent-evaluation) ⭐365 — Provide an AWS framework for evaluating AI agent performance.
...
- [bigcode-evaluation-harness](https://github.com/bigcode-project/bigcode-evaluation-harness) ⭐1048 — Evaluates code generation models on HumanEval, MBPP, and other benchmarks.
...
- [claw-eval](https://github.com/claw-eval/claw-eval) ⭐645 — Provide an evaluation harness for coding LLM agents.
...
- [collaborative-gym](https://github.com/SALT-NLP/collaborative-gym) ⭐138 — Framework for building and evaluating human-AI collaborative agents. 🤝
...
- [evals](https://github.com/strands-agents/evals) ⭐134 — Evaluation framework for AI agents and LLM apps with automated agentic testing. 🐍

### G–L

- [harbor](https://github.com/harbor-framework/harbor) ⭐2335 — Runs AI agent evals and RL environments with terminal-based benchmarking.
...
- [intellagent](https://github.com/plurai-ai/intellagent) ⭐1232 — Provide an intelligent evaluation harness for AI agents.
- [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐12863 — General-purpose LLM evaluation framework supporting hundreds of benchmarks.
...
- [OpenAI Evals](https://github.com/openai/evals) ⭐18628 — Provide a framework for evaluating LLM model outputs.
...
- [OpenHands Eval Harness](https://github.com/All-Hands-AI/OpenHands) ⭐76192 — Built-in eval framework for OpenHands supporting SWE-bench and more, 30x faster.
...
- [SanityHarness](https://github.com/lemon07r/SanityHarness) ⭐226 — Provide a sanity-check harness for agent evaluation pipelines. 🌐
...
- [smolagents](https://github.com/huggingface/smolagents) ⭐27748 — Hugging Face lightweight framework for building and running LLM-powered agents. 🤝 🐍
- [squeez](https://github.com/KRLabsOrg/squeez) ⭐17 — Compresses verbose tool outputs for coding agents via LoRA fine-tuning.
- [SWE Agent](https://github.com/princeton-nlp/swe-agent) ⭐19448 — Provide an agent harness for solving software engineering tasks.
...
- [SWE-bench Experiments](https://github.com/SWE-bench/experiments) ⭐268 — Provide experiment tracking for SWE-bench evaluation runs.
- [Test-Agent](https://github.com/codefuse-ai/Test-Agent) ⭐698 — LLM-powered software testing agent for industrial use cases.
- [token-savior](https://github.com/Mibayy/token-savior) ⭐965 — Provide token-efficient optimization for agent evaluation runs.
- [ts-bench](https://github.com/laiso/ts-bench) ⭐235 — CLI benchmark tool for evaluating AI coding agents on TypeScript workloads. 🔷
- [upskill](https://github.com/huggingface/upskill) ⭐674 — Generates and evaluates coding skills of agents like Claude Code and Codex.
...
- [agent-safehouse](https://github.com/eugene1g/agent-safehouse) ⭐1844 — Sandbox for local AI agents with scoped read/write filesystem access.
- [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐2789 — Kubernetes-based sandbox runtime for isolated stateful AI agent workloads.
...
- [artifact-fs](https://github.com/cloudflare/artifact-fs) ⭐920 — FUSE filesystem driver for lazy-mounting large git repos in agent sandboxes.
...
- [boxlite](https://github.com/boxlite-ai/boxlite) ⭐2113 — Embeddable sandbox for AI agents with snapshots, state and hardware isolation.
...
- [coderunner](https://github.com/instavm/coderunner) ⭐836 — Local isolated sandbox for AI agents to run code safely in containers.
- [cua](https://github.com/trycua/cua) ⭐17746 — Sandbox infra for computer-use agents with macOS/Linux/Windows VMs and SDK.
- [CubeSandbox](https://github.com/TencentCloud/CubeSandbox) ⭐6211 — Sandbox for secure AI agent code execution with instant concurrent containers. 🦀
...
- [E2B](https://github.com/e2b-dev/E2B) ⭐12507 — Sandbox for secure AI agent code execution with Firecracker microVMs.
- [exec-sandbox](https://github.com/dualeai/exec-sandbox) ⭐30 — Provide a sandboxed environment for secure code execution.
...
- [gondolin](https://github.com/earendil-works/gondolin) ⭐1356 — Experimental agent sandbox using Linux microVMs with TypeScript control plane. 🔷
- [judge0](https://github.com/judge0/judge0) ⭐4222 — Open-source sandboxed code execution system supporting 60+ languages. 🌐
...
- [microsandbox](https://github.com/superradcompany/microsandbox) ⭐6451 — Provide lightweight micro-sandboxes for secure code execution. 🔒
- [mithril](https://github.com/radimsem/mithril) ⭐16 — Trustless MCP server with sandboxed execution tools for AI coding agents.
...
- [nono](https://github.com/always-further/nono) ⭐2600 — Zero-config AI agent sandbox with capability-model-based multiplexed isolation.
...
- [OpenSandbox](https://github.com/alibaba/OpenSandbox) ⭐11392 — Provide an open-source sandbox for secure code execution.
...
- [python-sandbox](https://github.com/onyx-dot-app/python-sandbox) ⭐24 — Secure lightweight Python code execution sandbox for LLM/AI agents. 🐍
...
- [sandbox](https://github.com/agent-infra/sandbox) ⭐4921 — Provide a general-purpose sandbox for isolated code execution.
- [sandbox-agent](https://github.com/rivet-dev/sandbox-agent) ⭐1422 — Run coding agents in sandboxed environments with HTTP control for evaluation.
- [sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) ⭐1036 — SDK for running sandboxed code environments on Cloudflare's edge network.
...
- [secure-exec](https://github.com/rivet-dev/secure-exec) ⭐893 — Provide secure execution sandboxes for untrusted code.
...
- [SmolVM](https://github.com/CelestoAI/SmolVM) ⭐584 — Lightweight open-source VM sandbox for AI agent code execution and browser use.
...
- [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐520 — Provide remote execution sandboxes for SWE-bench evaluation.
...
- [the-agent-sandbox-taxonomy](https://github.com/kajogo777/the-agent-sandbox-taxonomy) ⭐78 — Taxonomy and scoring framework for AI agent sandboxes with 7 defense layers.
- [vibe](https://github.com/lynaghk/vibe) ⭐924 — Provide a sandbox environment for code execution and testing. 🦀
- [vibekit](https://github.com/superagent-ai/vibekit) ⭐1791 — Provide a toolkit for building sandboxed coding environments. 🤝
- [wuying-agentbay-sdk](https://github.com/agentbay-ai/wuying-agentbay-sdk) ⭐1131 — Cloud sandbox environment SDK built for AI agents.
- [zeroboot](https://github.com/zerobootdev/zeroboot) ⭐2359 — Provide zero-setup sandbox bootstrapping for code evaluation.

<a id="observability"></a>
## Observability

- [agentevals](https://github.com/agentevals-dev/agentevals) ⭐135 — Evaluates AI agents via OpenTelemetry traces in a framework-agnostic way.
...
- [Langfuse](https://github.com/langfuse/langfuse) ⭐28651 — Open-source LLM observability platform with tracing, spans, and scoring.
- [Observal](https://github.com/BlazeUp-AI/Observal) ⭐2039 — Provide observability tooling for AI agent evaluation.
- [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst) ⭐16170 — Python SDK for AI agent observability, tracing, monitoring and evaluation. 🤝
- [RepoAgent](https://github.com/OpenBMB/RepoAgent) ⭐982 — LLM-powered framework for automated repository documentation generation.
...
- [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐21991 — Tests and evaluates LLM outputs with prompt comparison and auto-scoring.
