...
- [any-agent](https://github.com/mozilla-ai/any-agent) ⭐1177 — Unified interface to build agents across frameworks with tracing and scoring.
...
- [claw-eval](https://github.com/claw-eval/claw-eval) ⭐677 — Provide an evaluation harness for coding LLM agents.
...
- [collaborative-gym](https://github.com/SALT-NLP/collaborative-gym) ⭐140 — Framework for building and evaluating human-AI collaborative agents. 🤝
...
- [evals](https://github.com/strands-agents/evals) ⭐147 — Evaluation framework for AI agents and LLM apps with automated agentic testing. 🐍

### G–L

- [harbor](https://github.com/harbor-framework/harbor) ⭐2619 — Runs AI agent evals and RL environments with terminal-based benchmarking.
...
- [intellagent](https://github.com/plurai-ai/intellagent) ⭐1236 — Provide an intelligent evaluation harness for AI agents.
- [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐13023 — General-purpose LLM evaluation framework supporting hundreds of benchmarks.
...
- [OpenAI Evals](https://github.com/openai/evals) ⭐18736 — Provide a framework for evaluating LLM model outputs.
...
- [OpenHands Eval Harness](https://github.com/All-Hands-AI/OpenHands) ⭐77965 — Built-in eval framework for OpenHands supporting SWE-bench and more, 30x faster.
...
- [SanityHarness](https://github.com/lemon07r/SanityHarness) ⭐230 — Provide a sanity-check harness for agent evaluation pipelines. 🌐
- [sb-cli](https://github.com/SWE-bench/sb-cli) ⭐72 — Official SWE-bench CLI tool for running remote evaluation tasks.
...
- [smolagents](https://github.com/huggingface/smolagents) ⭐27950 — Hugging Face lightweight framework for building and running LLM-powered agents. 🤝 🐍
- [squeez](https://github.com/KRLabsOrg/squeez) ⭐18 — Compresses verbose tool outputs for coding agents via LoRA fine-tuning.
- [SWE Agent](https://github.com/princeton-nlp/swe-agent) ⭐19585 — Provide an agent harness for solving software engineering tasks.
...
- [token-savior](https://github.com/Mibayy/token-savior) ⭐1002 — Provide token-efficient optimization for agent evaluation runs.
- [ts-bench](https://github.com/laiso/ts-bench) ⭐235 — CLI benchmark tool for evaluating AI coding agents on TypeScript workloads. 🔷
- [upskill](https://github.com/huggingface/upskill) ⭐686 — Generates and evaluates coding skills of agents like Claude Code and Codex.
...
- [agent-safehouse](https://github.com/eugene1g/agent-safehouse) ⭐1869 — Sandbox for local AI agents with scoped read/write filesystem access.
- [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐2938 — Kubernetes-based sandbox runtime for isolated stateful AI agent workloads.
...
- [arrakis](https://github.com/abshkbh/arrakis) ⭐817 — Provide sandboxed execution environments for code evaluation.
- [artifact-fs](https://github.com/cloudflare/artifact-fs) ⭐997 — FUSE filesystem driver for lazy-mounting large git repos in agent sandboxes.
...
- [boxlite](https://github.com/boxlite-ai/boxlite) ⭐2082 — Embeddable sandbox for AI agents with snapshots, state and hardware isolation.
...
- [cua](https://github.com/trycua/cua) ⭐18591 — Sandbox infra for computer-use agents with macOS/Linux/Windows VMs and SDK.
- [CubeSandbox](https://github.com/TencentCloud/CubeSandbox) ⭐6430 — Sandbox for secure AI agent code execution with instant concurrent containers. 🦀
...
- [E2B](https://github.com/e2b-dev/E2B) ⭐12670 — Sandbox for secure AI agent code execution with Firecracker microVMs.
...
- [gondolin](https://github.com/earendil-works/gondolin) ⭐1454 — Experimental agent sandbox using Linux microVMs with TypeScript control plane. 🔷
- [judge0](https://github.com/judge0/judge0) ⭐4256 — Open-source sandboxed code execution system supporting 60+ languages. 🌐
...
- [microsandbox](https://github.com/superradcompany/microsandbox) ⭐6640 — Provide lightweight micro-sandboxes for secure code execution. 🔒
...
- [nono](https://github.com/always-further/nono) ⭐2761 — Zero-config AI agent sandbox with capability-model-based multiplexed isolation.
- [openhands-aci](https://github.com/All-Hands-AI/openhands-aci) ⭐129 — Defines standard interface layer for agent-computer interaction in OpenHands.
- [OpenSandbox](https://github.com/alibaba/OpenSandbox) ⭐11601 — Provide an open-source sandbox for secure code execution.
- [pctx](https://github.com/portofcontext/pctx) ⭐263 — Execution layer running agentic tool calls in secure sandboxes for AI workflows.
...
- [sandbox](https://github.com/agent-infra/sandbox) ⭐5201 — Provide a general-purpose sandbox for isolated code execution.
- [sandbox-agent](https://github.com/rivet-dev/sandbox-agent) ⭐1442 — Run coding agents in sandboxed environments with HTTP control for evaluation.
- [sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) ⭐1047 — SDK for running sandboxed code environments on Cloudflare's edge network.
...
- [secure-exec](https://github.com/rivet-dev/secure-exec) ⭐913 — Provide secure execution sandboxes for untrusted code.
...
- [SmolVM](https://github.com/CelestoAI/SmolVM) ⭐617 — Lightweight open-source VM sandbox for AI agent code execution and browser use.
...
- [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐538 — Provide remote execution sandboxes for SWE-bench evaluation.
...
- [the-agent-sandbox-taxonomy](https://github.com/kajogo777/the-agent-sandbox-taxonomy) ⭐82 — Taxonomy and scoring framework for AI agent sandboxes with 7 defense layers.
- [vibe](https://github.com/lynaghk/vibe) ⭐931 — Provide a sandbox environment for code execution and testing. 🦀
- [vibekit](https://github.com/superagent-ai/vibekit) ⭐1800 — Provide a toolkit for building sandboxed coding environments. 🤝
- [wuying-agentbay-sdk](https://github.com/agentbay-ai/wuying-agentbay-sdk) ⭐1137 — Cloud sandbox environment SDK built for AI agents.
- [zeroboot](https://github.com/zerobootdev/zeroboot) ⭐2373 — Provide zero-setup sandbox bootstrapping for code evaluation.

<a id="observability"></a>
## Observability

- [agentevals](https://github.com/agentevals-dev/agentevals) ⭐138 — Evaluates AI agents via OpenTelemetry traces in a framework-agnostic way.
...
- [Langfuse](https://github.com/langfuse/langfuse) ⭐29492 — Open-source LLM observability platform with tracing, spans, and scoring.
- [Observal](https://github.com/BlazeUp-AI/Observal) ⭐2111 — Provide observability tooling for AI agent evaluation.
- [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst) ⭐16151 — Python SDK for AI agent observability, tracing, monitoring and evaluation. 🤝
...
- [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐22444 — Tests and evaluates LLM outputs with prompt comparison and auto-scoring.
- [sage](https://github.com/usetig/sage) ⭐98 — LLM council that reviews and evaluates coding agent actions in real-time. 🤖
