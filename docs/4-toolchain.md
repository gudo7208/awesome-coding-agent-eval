...
- [AgentEval](https://github.com/AgentEvalHQ/AgentEval) ⭐107 — AgentEval.
- [aider-swe-bench](https://github.com/Aider-AI/aider-swe-bench) ⭐83 — Harness for running and evaluating Aider on SWE-Bench benchmark.
...
- [any-agent](https://github.com/mozilla-ai/any-agent) ⭐1170 — Unified interface to build agents across frameworks with tracing and scoring.
...
- [awslabs/agent-evaluation](https://github.com/awslabs/agent-evaluation) ⭐363 — awslabs/agent-evaluation.
...
- [bigcode-evaluation-harness](https://github.com/bigcode-project/bigcode-evaluation-harness) ⭐1046 — Evaluates code generation models on HumanEval, MBPP, and other benchmarks.
...
- [claw-eval](https://github.com/claw-eval/claw-eval) ⭐609 — claw-eval.
- [codex-long-running-harness](https://github.com/LongWeihan/codex-long-running-harness) ⭐17 — codex-long-running-harness. 📅
- [collaborative-gym](https://github.com/SALT-NLP/collaborative-gym) ⭐132 — Framework for building and evaluating human-AI collaborative agents. 🤝
- [evalmonkey](https://github.com/Corbell-AI/evalmonkey) ⭐33 — CLI eval harness for AI coding agents with benchmark and chaos fault injection.
- [evals](https://github.com/strands-agents/evals) ⭐130 — Evaluation framework for AI agents and LLM apps with automated agentic testing. 🐍

### G–L

- [harbor](https://github.com/harbor-framework/harbor) ⭐2102 — Runs AI agent evals and RL environments with terminal-based benchmarking.
...
- [intellagent](https://github.com/plurai-ai/intellagent) ⭐1231 — intellagent.
- [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness) ⭐12676 — General-purpose LLM evaluation framework supporting hundreds of benchmarks.
...
- [OpenAI Evals](https://github.com/openai/evals) ⭐18528 — OpenAI Evals.
...
- [OpenHands Eval Harness](https://github.com/All-Hands-AI/OpenHands) ⭐74771 — Built-in eval framework for OpenHands supporting SWE-bench and more, 30x faster.
...
- [sb-cli](https://github.com/SWE-bench/sb-cli) ⭐67 — Official SWE-bench CLI tool for running remote evaluation tasks.
- [smolagents](https://github.com/huggingface/smolagents) ⭐27493 — Hugging Face lightweight framework for building and running LLM-powered agents. 🤝 🐍
- [squeez](https://github.com/KRLabsOrg/squeez) ⭐17 — Compresses verbose tool outputs for coding agents via LoRA fine-tuning.
- [SWE Agent](https://github.com/princeton-nlp/swe-agent) ⭐19294 — SWE Agent.
...
- [SWE-bench Experiments](https://github.com/SWE-bench/experiments) ⭐265 — SWE-bench Experiments.
- [Test-Agent](https://github.com/codefuse-ai/Test-Agent) ⭐696 — LLM-powered software testing agent for industrial use cases.
- [token-savior](https://github.com/Mibayy/token-savior) ⭐904 — token-savior.
- [ts-bench](https://github.com/laiso/ts-bench) ⭐234 — CLI benchmark tool for evaluating AI coding agents on TypeScript workloads. 🔷
- [upskill](https://github.com/huggingface/upskill) ⭐648 — Generates and evaluates coding skills of agents like Claude Code and Codex.
...
- [agent-safehouse](https://github.com/eugene1g/agent-safehouse) ⭐1803 — Sandbox for local AI agents with scoped read/write filesystem access.
- [agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) ⭐2354 — Kubernetes-based sandbox runtime for isolated stateful AI agent workloads.
...
- [arrakis](https://github.com/abshkbh/arrakis) ⭐813 — arrakis.
- [artifact-fs](https://github.com/cloudflare/artifact-fs) ⭐856 — FUSE filesystem driver for lazy-mounting large git repos in agent sandboxes.
...
- [boxlite](https://github.com/boxlite-ai/boxlite) ⭐2085 — Embeddable sandbox for AI agents with snapshots, state and hardware isolation.
...
- [coderunner](https://github.com/instavm/coderunner) ⭐831 — Local isolated sandbox for AI agents to run code safely in containers.
- [cua](https://github.com/trycua/cua) ⭐17066 — Sandbox infra for computer-use agents with macOS/Linux/Windows VMs and SDK.
- [CubeSandbox](https://github.com/TencentCloud/CubeSandbox) ⭐5906 — Sandbox for secure AI agent code execution with instant concurrent containers. 🦀
...
- [E2B](https://github.com/e2b-dev/E2B) ⭐12341 — Sandbox for secure AI agent code execution with Firecracker microVMs.
- [exec-sandbox](https://github.com/dualeai/exec-sandbox) ⭐25 — exec-sandbox.
...
- [gondolin](https://github.com/earendil-works/gondolin) ⭐1261 — Experimental agent sandbox using Linux microVMs with TypeScript control plane. 🔷
- [judge0](https://github.com/judge0/judge0) ⭐4188 — Open-source sandboxed code execution system supporting 60+ languages. 🌐
...
- [microsandbox](https://github.com/superradcompany/microsandbox) ⭐6267 — microsandbox. 🔒
...
- [nono](https://github.com/always-further/nono) ⭐2467 — Zero-config AI agent sandbox with capability-model-based multiplexed isolation.
...
- [OpenSandbox](https://github.com/alibaba/OpenSandbox) ⭐10795 — OpenSandbox.
- [pctx](https://github.com/portofcontext/pctx) ⭐255 — Execution layer running agentic tool calls in secure sandboxes for AI workflows.
...
- [sandbox](https://github.com/agent-infra/sandbox) ⭐4789 — sandbox.
- [sandbox-agent](https://github.com/rivet-dev/sandbox-agent) ⭐1404 — Run coding agents in sandboxed environments with HTTP control for evaluation.
- [sandbox-sdk](https://github.com/cloudflare/sandbox-sdk) ⭐1028 — SDK for running sandboxed code environments on Cloudflare's edge network.
...
- [secure-exec](https://github.com/rivet-dev/secure-exec) ⭐873 — secure-exec.
- [skypilot-code-sandbox](https://github.com/alex000kim/skypilot-code-sandbox) ⭐17 — skypilot-code-sandbox.
- [SmolVM](https://github.com/CelestoAI/SmolVM) ⭐561 — Lightweight open-source VM sandbox for AI agent code execution and browser use.
...
- [SWE-ReX](https://github.com/SWE-agent/SWE-ReX) ⭐508 — SWE-ReX.
...
- [the-agent-sandbox-taxonomy](https://github.com/kajogo777/the-agent-sandbox-taxonomy) ⭐75 — Taxonomy and scoring framework for AI agent sandboxes with 7 defense layers.
- [vibe](https://github.com/lynaghk/vibe) ⭐914 — vibe. 🦀
- [vibekit](https://github.com/superagent-ai/vibekit) ⭐1789 — vibekit. 🤝
- [wuying-agentbay-sdk](https://github.com/agentbay-ai/wuying-agentbay-sdk) ⭐1124 — Cloud sandbox environment SDK built for AI agents.
- [zeroboot](https://github.com/zerobootdev/zeroboot) ⭐2340 — zeroboot.

<a id="observability"></a>
## Observability

- [agentevals](https://github.com/agentevals-dev/agentevals) ⭐132 — Evaluates AI agents via OpenTelemetry traces in a framework-agnostic way.
...
- [Langfuse](https://github.com/langfuse/langfuse) ⭐27850 — Open-source LLM observability platform with tracing, spans, and scoring.
- [Observal](https://github.com/BlazeUp-AI/Observal) ⭐1463 — Observal.
- [RagaAI-Catalyst](https://github.com/raga-ai-hub/RagaAI-Catalyst) ⭐16164 — Python SDK for AI agent observability, tracing, monitoring and evaluation. 🤝
- [RepoAgent](https://github.com/OpenBMB/RepoAgent) ⭐967 — LLM-powered framework for automated repository documentation generation.
...
- [diffdeck](https://github.com/KnockOutEZ/diffdeck) ⭐48 — diffdeck.
...
- [Promptfoo](https://github.com/promptfoo/promptfoo) ⭐21565 — Tests and evaluates LLM outputs with prompt comparison and auto-scoring.
