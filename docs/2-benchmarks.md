...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5454 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5454 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5454 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [ai-agent-benchmark](https://github.com/murataslan1/ai-agent-benchmark) ⭐27 — Leaderboard comparing 80+ AI coding agents on SWE-Bench with pricing info. 🏆
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐174 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐461 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐113 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐188 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [MMBench-GUI](https://github.com/open-compass/MMBench-GUI) ⭐112 — Hierarchical benchmark for GUI agents across desktop, mobile, and web platforms.
...
- [skill](https://github.com/pinchbench/skill) ⭐1285 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐209 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐59 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) ⭐1436 — Benchmarks LLMs on 1400+ real freelance software engineering tasks worth $1M+.
...
- [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ⭐89 — Benchmark autonomous agents in 1M-token real-world contexts with user simulation. 🌍
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐62 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐186 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐484 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐395 — Benchmark reinforcement learning agents on terminal tasks. 📅
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐191 — Benchmark LLMs on automated code review tasks. 🌐
...
- [AICGSecEval](https://github.com/Tencent/AICGSecEval) ⭐646 — Evaluate security of AI-generated code.
...
- [auto-pen-bench](https://github.com/lucagioacchini/auto-pen-bench) ⭐88 — Benchmarks generative agents on automated penetration testing scenarios. 🔒
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐545 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [HackSynth](https://github.com/aielte-research/HackSynth) ⭐309 — Evaluates LLM agents on autonomous penetration testing via CTF challenges.
...
- [RedCode](https://github.com/AI-secure/RedCode) ⭐85 — Benchmark for risky code execution and generation by code agents. 🔒
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐515 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [da-code](https://github.com/yiyihum/da-code) ⭐102 — Benchmarks agent code generation on real-world data science tasks.
...
- [Github](https://github.com/openai/human-eval) ⭐3310 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐911 — Benchmark code generation with continuously updated problems.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐184 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐62 — Benchmark LLM code generation capabilities.
...
- [CooperBench](https://github.com/cooperbench/CooperBench) ⭐18 — Benchmark cooperative multi-agent coding collaboration. 🤝
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐281 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6622 — Open benchmark framework for evaluating multi-agent systems. 🤝
