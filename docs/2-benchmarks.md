...
- [joycode-agent](https://github.com/jd-opensource/joycode-agent) ⭐338 — Repository-level repair agent built and evaluated on SWE-Bench.
...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐352 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5404 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5404 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5404 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐456 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐111 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐50 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐181 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [devin-swebench-results](https://github.com/CognitionAI/devin-swebench-results) ⭐123 — Cognition's published Devin evaluation results and methodology on SWE-bench.
...
- [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ⭐256 — Evaluate agents on Git-based software engineering tasks.
...
- [skill](https://github.com/pinchbench/skill) ⭐1273 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐208 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [SWE-PolyBench](https://github.com/amazon-science/SWE-PolyBench) ⭐88 — Benchmark coding agents across multiple programming languages. 🌐
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐54 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) ⭐1437 — Benchmarks LLMs on 1400+ real freelance software engineering tasks worth $1M+.
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐60 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐172 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐475 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐188 — Benchmark LLMs on automated code review tasks. 🌐
...
- [aicrypto-agent](https://github.com/wangyu-ovo/aicrypto-agent) ⭐36 — Benchmark evaluating LLM cryptography capabilities for AI SE agents. 🔒
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐520 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐68 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [RedCode](https://github.com/AI-secure/RedCode) ⭐84 — Benchmark for risky code execution and generation by code agents. 🔒
...
- [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ⭐161 — Benchmarks AI code generation across 13 programming languages. 🌐
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐514 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [da-code](https://github.com/yiyihum/da-code) ⭐101 — Benchmarks agent code generation on real-world data science tasks.
...
- [Github](https://github.com/openai/human-eval) ⭐3297 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐905 — Benchmark code generation with continuously updated problems.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐183 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐61 — Benchmark LLM code generation capabilities.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐80 — Benchmark agents on end-to-end feature development tasks.
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐277 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6568 — Open benchmark framework for evaluating multi-agent systems. 🤝
