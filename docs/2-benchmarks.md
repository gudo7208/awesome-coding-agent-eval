...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐337 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5104 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5104 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5104 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐159 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐438 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐103 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐33 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐164 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [MMBench-GUI](https://github.com/open-compass/MMBench-GUI) ⭐111 — Hierarchical benchmark for GUI agents across desktop, mobile, and web platforms.
...
- [skill](https://github.com/pinchbench/skill) ⭐1223 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐194 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐45 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ⭐86 — Benchmark autonomous agents in 1M-token real-world contexts with user simulation. 🌍
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐127 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐430 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐167 — Benchmark LLMs on automated code review tasks. 🌐
...
- [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ⭐82 — Benchmark LLM-generated tests for real-world software projects. 🐍
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐397 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐57 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐503 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [Github](https://github.com/openai/human-eval) ⭐3251 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐881 — Benchmark code generation with continuously updated problems.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐178 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [verina](https://github.com/sunblaze-ucb/verina) ⭐68 — Benchmark for verifiable code, specification, and proof generation evaluation.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐57 — Benchmark LLM code generation capabilities.
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐261 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6337 — Open benchmark framework for evaluating multi-agent systems. 🤝
