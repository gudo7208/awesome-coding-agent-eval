...
- [joycode-agent](https://github.com/jd-opensource/joycode-agent) ⭐335 — Repository-level repair agent built and evaluated on SWE-Bench.
...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐339 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5170 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5170 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5170 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [ABC-Bench](https://github.com/OpenMOSS/ABC-Bench) ⭐32 — Benchmark end-to-end coding agent capabilities.
- [AdamBench](https://github.com/tabupl/AdamBench) ⭐29 — Agentic coding benchmark for local LLMs on daily software engineering tasks.
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐161 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐442 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐105 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐43 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [benchmarks](https://github.com/0xpayne/gpt-migrate#-benchmarks) ⭐6977 — GPT-Migrate benchmarks for automated codebase migration between frameworks.
...
- [ccbench](https://github.com/codecrafters-io/ccbench) ⭐34 — CodeCrafters benchmark tool for evaluating coding agents on SE tasks. 🦀
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐168 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [skill](https://github.com/pinchbench/skill) ⭐1231 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐199 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐50 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) ⭐1440 — Benchmarks LLMs on 1400+ real freelance software engineering tasks worth $1M+.
...
- [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ⭐87 — Benchmark autonomous agents in 1M-token real-world contexts with user simulation. 🌍
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐51 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐133 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [LifelongAgentBench](https://github.com/caixd-220529/LifelongAgentBench) ⭐91 — Benchmark evaluating LLM agents as lifelong learners across tasks. 📅
...
- [LoCoBench-Agent](https://github.com/SalesforceAIResearch/LoCoBench-Agent) ⭐20 — Long-context interactive benchmark for LLM agents on multi-turn code tasks.
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐443 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐392 — Benchmark reinforcement learning agents on terminal tasks. 📅
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐171 — Benchmark LLMs on automated code review tasks. 🌐
...
- [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ⭐83 — Benchmark LLM-generated tests for real-world software projects. 🐍
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐413 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐60 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ⭐159 — Benchmarks AI code generation across 13 programming languages. 🌐
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐507 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [Github](https://github.com/openai/human-eval) ⭐3259 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐884 — Benchmark code generation with continuously updated problems.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐180 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐75 — Benchmark agents on end-to-end feature development tasks.
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐265 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6376 — Open benchmark framework for evaluating multi-agent systems. 🤝
