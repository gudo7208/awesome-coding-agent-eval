...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐341 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5225 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5225 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5225 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [swe-bench.github.io](https://github.com/SWE-bench/swe-bench.github.io) ⭐13 — Provide official results website and leaderboard for SWE-bench. 🏆
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐162 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐106 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐47 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [benchmarks](https://github.com/0xpayne/gpt-migrate#-benchmarks) ⭐6978 — GPT-Migrate benchmarks for automated codebase migration between frameworks.
...
- [ccbench](https://github.com/codecrafters-io/ccbench) ⭐35 — CodeCrafters benchmark tool for evaluating coding agents on SE tasks. 🦀
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐170 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [skill](https://github.com/pinchbench/skill) ⭐1244 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐200 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐155 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐450 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐175 — Benchmark LLMs on automated code review tasks. 🌐
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐428 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [HackSynth](https://github.com/aielte-research/HackSynth) ⭐311 — Evaluates LLM agents on autonomous penetration testing via CTF challenges.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐63 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐509 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [Github](https://github.com/openai/human-eval) ⭐3268 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐887 — Benchmark code generation with continuously updated problems.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐76 — Benchmark agents on end-to-end feature development tasks.
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐268 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6417 — Open benchmark framework for evaluating multi-agent systems. 🤝
