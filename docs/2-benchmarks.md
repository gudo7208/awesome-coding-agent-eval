...
- [joycode-agent](https://github.com/jd-opensource/joycode-agent) ⭐332 — Repository-level repair agent built and evaluated on SWE-Bench.
...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐334 — multi-swe-bench. 🌐
...
- [Rust-SWE-Bench](https://github.com/GhabiX/Rust-SWE-Bench) ⭐13 — Evaluates agent issue-resolution ability on real Rust project GitHub issues. 🦀
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5006 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5006 — SWE-bench Multimodal.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5006 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐147 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐423 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐31 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [benchmarks](https://github.com/0xpayne/gpt-migrate#-benchmarks) ⭐6980 — GPT-Migrate benchmarks for automated codebase migration between frameworks.
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐158 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [skill](https://github.com/pinchbench/skill) ⭐1196 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐40 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐121 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐398 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐385 — terminal-bench-rl. 📅
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐155 — aacr-bench. 🌐
...
- [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ⭐79 — SWT-Bench. 🐍
...
- [AICGSecEval](https://github.com/Tencent/AICGSecEval) ⭐796 — AICGSecEval.
...
- [auto-pen-bench](https://github.com/lucagioacchini/auto-pen-bench) ⭐85 — Benchmarks generative agents on automated penetration testing scenarios. 🔒
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐357 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐51 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [codefuse-evaluation](https://github.com/codefuse-ai/codefuse-evaluation) ⭐110 — codefuse-evaluation.
...
- [Github](https://github.com/openai/human-eval) ⭐3240 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐872 — LiveCodeBench.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐55 — wp-bench.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐68 — FeatureBench.
...
- [CooperBench](https://github.com/cooperbench/CooperBench) ⭐14 — CooperBench. 🤝
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐257 — MARBLE. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6241 — Open benchmark framework for evaluating multi-agent systems. 🤝
...
- [sweet_rl](https://github.com/facebookresearch/sweet_rl) ⭐268 — Benchmarks multi-turn collaborative reasoning for LLM agent training.
