...
- [joycode-agent](https://github.com/jd-opensource/joycode-agent) ⭐339 — Repository-level repair agent built and evaluated on SWE-Bench.
...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐354 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [Rust-SWE-Bench](https://github.com/GhabiX/Rust-SWE-Bench) ⭐16 — Evaluates agent issue-resolution ability on real Rust project GitHub issues. 🦀
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5487 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5487 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5487 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [swe-bench-lite-samples](https://github.com/ScalingIntelligence/swe-bench-lite-samples) ⭐15 — Provide sample task instances from the SWE-bench Lite subset.
...
- [swe-bench.github.io](https://github.com/SWE-bench/swe-bench.github.io) ⭐15 — Provide official results website and leaderboard for SWE-bench. 🏆
...
- [ai-agent-benchmark](https://github.com/murataslan1/ai-agent-benchmark) ⭐28 — Leaderboard comparing 80+ AI coding agents on SWE-Bench with pricing info. 🏆
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐176 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐471 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐116 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐54 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐192 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ⭐257 — Evaluate agents on Git-based software engineering tasks.
...
- [leaderboard](https://github.com/pinchbench/leaderboard) ⭐40 — Leaderboard ranking LLM coding agents on end-to-end programming tasks. 🏆
...
- [skill](https://github.com/pinchbench/skill) ⭐1299 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐213 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [SWE-PolyBench](https://github.com/amazon-science/SWE-PolyBench) ⭐89 — Benchmark coding agents across multiple programming languages. 🌐
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐61 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [SWELancer-Benchmark](https://github.com/openai/SWELancer-Benchmark) ⭐1434 — Benchmarks LLMs on 1400+ real freelance software engineering tasks worth $1M+.
...
- [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ⭐90 — Benchmark autonomous agents in 1M-token real-world contexts with user simulation. 🌍
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐63 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐194 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅

### G–L

- [goodai-ltm-benchmark](https://github.com/GoodAI/goodai-ltm-benchmark) ⭐88 — Benchmark long-term memory capabilities of AI agents.
...
- [LifelongAgentBench](https://github.com/caixd-220529/LifelongAgentBench) ⭐94 — Benchmark evaluating LLM agents as lifelong learners across tasks. 📅
...
- [LoCoBench-Agent](https://github.com/SalesforceAIResearch/LoCoBench-Agent) ⭐22 — Long-context interactive benchmark for LLM agents on multi-turn code tasks.
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐487 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐399 — Benchmark reinforcement learning agents on terminal tasks. 📅
...
- [legacy-bench](https://github.com/Factory-AI/legacy-bench) ⭐18 — Benchmark agent performance on legacy codebase tasks.
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐193 — Benchmark LLMs on automated code review tasks. 🌐
...
- [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ⭐85 — Benchmark LLM-generated tests for real-world software projects. 🐍
...
- [AICGSecEval](https://github.com/Tencent/AICGSecEval) ⭐647 — Evaluate security of AI-generated code.
- [aicrypto-agent](https://github.com/wangyu-ovo/aicrypto-agent) ⭐37 — Benchmark evaluating LLM cryptography capabilities for AI SE agents. 🔒
...
- [auto-pen-bench](https://github.com/lucagioacchini/auto-pen-bench) ⭐90 — Benchmarks generative agents on automated penetration testing scenarios. 🔒
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐579 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐69 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [RedCode](https://github.com/AI-secure/RedCode) ⭐86 — Benchmark for risky code execution and generation by code agents. 🔒
...
- [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ⭐166 — Benchmarks AI code generation across 13 programming languages. 🌐
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐518 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [da-code](https://github.com/yiyihum/da-code) ⭐103 — Benchmarks agent code generation on real-world data science tasks.
...
- [Github](https://github.com/openai/human-eval) ⭐3320 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐913 — Benchmark code generation with continuously updated problems.
...
- [ML-Bench](https://github.com/gersteinlab/ML-Bench) ⭐314 — Evaluates LLM/agent ML task completion on 10K+ samples across 18 GitHub repos.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐185 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [verina](https://github.com/sunblaze-ucb/verina) ⭐73 — Benchmark for verifiable code, specification, and proof generation evaluation.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐65 — Benchmark LLM code generation capabilities.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐83 — Benchmark agents on end-to-end feature development tasks.
...
- [CooperBench](https://github.com/cooperbench/CooperBench) ⭐19 — Benchmark cooperative multi-agent coding collaboration. 🤝
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐280 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6666 — Open benchmark framework for evaluating multi-agent systems. 🤝
...
- [sweet_rl](https://github.com/facebookresearch/sweet_rl) ⭐271 — Benchmarks multi-turn collaborative reasoning for LLM agent training.
