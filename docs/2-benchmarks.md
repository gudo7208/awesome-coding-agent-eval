...
- [joycode-agent](https://github.com/jd-opensource/joycode-agent) ⭐331 — Repository-level repair agent built and evaluated on SWE-Bench.
...
- [Rust-SWE-Bench](https://github.com/GhabiX/Rust-SWE-Bench) ⭐12 — Evaluates agent issue-resolution ability on real Rust project GitHub issues. 🦀
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐4962 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐4962 — SWE-bench Multimodal.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐4962 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [SWE-Bench-plus-plus](https://github.com/TuringEnterprises/SWE-Bench-plus-plus) ⭐24 — SWE-Bench-plus-plus.
...
- [ABC-Bench](https://github.com/OpenMOSS/ABC-Bench) ⭐31 — ABC-Bench.
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐145 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
- [Apex2-Terminal-Bench-Agent](https://github.com/heartyguy/Apex2-Terminal-Bench-Agent) ⭐67 — Benchmarks terminal-based coding agents with leaderboard and ablation results. 🏆
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐419 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [BC-Bench](https://github.com/microsoft/BC-Bench) ⭐29 — Evaluates AI agents on Microsoft Business Central AL codebase tasks.
...
- [benchmarks](https://github.com/0xpayne/gpt-migrate#-benchmarks) ⭐6979 — GPT-Migrate benchmarks for automated codebase migration between frameworks.
...
- [ccbench](https://github.com/codecrafters-io/ccbench) ⭐30 — CodeCrafters benchmark tool for evaluating coding agents on SE tasks. 🦀
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐154 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ⭐255 — GitTaskBench.
...
- [leaderboard](https://github.com/pinchbench/leaderboard) ⭐37 — Leaderboard ranking LLM coding agents on end-to-end programming tasks. 🏆
...
- [RefactorBench](https://github.com/microsoft/RefactorBench) ⭐26 — Benchmarks agents on cross-file code refactoring tasks in real repositories.
...
- [skill](https://github.com/pinchbench/skill) ⭐1174 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐192 — SWE-bench-Live. ✅
...
- [SWE-PolyBench](https://github.com/amazon-science/SWE-PolyBench) ⭐84 — SWE-PolyBench. 🌐
...
- [SWE-Skills-Bench](https://github.com/GeniusHTX/SWE-Skills-Bench) ⭐41 — Benchmarks decomposed SE agent skills like fault localization and code editing.
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐39 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐117 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [LifelongAgentBench](https://github.com/caixd-220529/LifelongAgentBench) ⭐89 — Benchmark evaluating LLM agents as lifelong learners across tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐386 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐383 — terminal-bench-rl. 📅
...
- [legacy-bench](https://github.com/Factory-AI/legacy-bench) ⭐14 — legacy-bench.
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐153 — aacr-bench. 🌐
...
- [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ⭐77 — SWT-Bench. 🐍
...
- [AICGSecEval](https://github.com/Tencent/AICGSecEval) ⭐935 — AICGSecEval.
...
- [auto-pen-bench](https://github.com/lucagioacchini/auto-pen-bench) ⭐84 — Benchmarks generative agents on automated penetration testing scenarios. 🔒
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐325 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [HackSynth](https://github.com/aielte-research/HackSynth) ⭐307 — Evaluates LLM agents on autonomous penetration testing via CTF challenges.
...
- [MaliciousAgentSkillsBench](https://github.com/protectskills/MaliciousAgentSkillsBench) ⭐46 — Evaluates agent resilience against malicious skill injection scenarios. 🔒
...
- [RedCode](https://github.com/AI-secure/RedCode) ⭐80 — Benchmark for risky code execution and generation by code agents. 🔒
...
- [scabench](https://github.com/scabench-org/scabench) ⭐111 — Benchmark for AI security audit agents on SCA and vulnerability detection tasks. 🔒
...
- [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ⭐156 — Benchmarks AI code generation across 13 programming languages. 🌐
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐500 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [da-code](https://github.com/yiyihum/da-code) ⭐97 — Benchmarks agent code generation on real-world data science tasks.
...
- [Github](https://github.com/openai/human-eval) ⭐3229 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐864 — LiveCodeBench.
...
- [ML-Bench](https://github.com/gersteinlab/ML-Bench) ⭐317 — Evaluates LLM/agent ML task completion on 10K+ samples across 18 GitHub repos.
...
- [svelte-bench](https://github.com/khromov/svelte-bench) ⭐173 — Benchmarks LLM code generation for Svelte 5 using HumanEval methodology.
...
- [verina](https://github.com/sunblaze-ucb/verina) ⭐63 — Benchmark for verifiable code, specification, and proof generation evaluation.
...
- [wp-bench](https://github.com/WordPress/wp-bench) ⭐54 — wp-bench.
...
- [FeatureBench](https://github.com/LiberCoders/FeatureBench) ⭐67 — FeatureBench.
...
- [CooperBench](https://github.com/cooperbench/CooperBench) ⭐13 — CooperBench. 🤝
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐254 — MARBLE. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6166 — Open benchmark framework for evaluating multi-agent systems. 🤝
