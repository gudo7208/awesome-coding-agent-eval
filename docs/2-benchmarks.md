...
- [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ⭐348 — Benchmark multi-language issue resolution extending SWE-bench. 🌐
...
- [Rust-SWE-Bench](https://github.com/GhabiX/Rust-SWE-Bench) ⭐15 — Evaluates agent issue-resolution ability on real Rust project GitHub issues. 🦀
...
- [SWE-bench](https://github.com/swe-bench/SWE-bench) ⭐5342 — 2294 real GitHub issues testing agent patch generation for Python bug fixes. 🐍
...
- [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ⭐5342 — Benchmark agents on multimodal software engineering tasks.
- [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ⭐5342 — 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues. 🐍
...
- [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ⭐169 — Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning.
...
- [appworld](https://github.com/StonyBrookNLP/appworld) ⭐449 — Evaluates agent tool-calling and planning across multi-app scenarios.
...
- [awesome-code-agents](https://github.com/EuniAI/awesome-code-agents) ⭐109 — Curated list of autonomous code agents, benchmarks, and research papers. 📋
...
- [CodeClash](https://github.com/CodeClash-ai/CodeClash) ⭐178 — Evaluates autonomous agent planning and execution on open-ended coding tasks.
...
- [skill](https://github.com/pinchbench/skill) ⭐1262 — Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks.
...
- [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ⭐206 — Evaluate agents on continuously updated real-world GitHub issues. ✅
...
- [AMA-Bench](https://github.com/AMA-Bench/AMA-Bench) ⭐56 — Benchmark for long-context retention and long-term memory in agent applications. 📅
...
- [frontier-swe](https://github.com/Proximal-Labs/frontier-swe) ⭐167 — Benchmarks coding agents on long-horizon impl, perf engineering, and ML tasks. 📅
...
- [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ⭐467 — Long-horizon SE task benchmark by Scale AI for multi-step complex engineering. 📅 🐍
...
- [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ⭐393 — Benchmark reinforcement learning agents on terminal tasks. 📅
...
- [legacy-bench](https://github.com/Factory-AI/legacy-bench) ⭐16 — Benchmark agent performance on legacy codebase tasks.
...
- [aacr-bench](https://github.com/alibaba/aacr-bench) ⭐184 — Benchmark LLMs on automated code review tasks. 🌐
...
- [AICGSecEval](https://github.com/Tencent/AICGSecEval) ⭐642 — Evaluate security of AI-generated code.
...
- [cybergym](https://github.com/sunblaze-ucb/cybergym) ⭐504 — Benchmarks AI agents on real-world vulnerability analysis at scale.
...
- [bigcodebench](https://github.com/bigcode-project/bigcodebench) ⭐512 — Benchmarks LLMs on complex function calls, tool use, and instruction following.
...
- [Github](https://github.com/openai/human-eval) ⭐3287 — HumanEval: OpenAI benchmark for evaluating code generation from docstrings. 🐍
...
- [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ⭐901 — Benchmark code generation with continuously updated problems.
...
- [CooperBench](https://github.com/cooperbench/CooperBench) ⭐16 — Benchmark cooperative multi-agent coding collaboration. 🤝
...
- [MARBLE](https://github.com/ulab-uiuc/MARBLE) ⭐276 — Benchmark multi-agent collaboration on software tasks. 🤝
...
- [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) ⭐6498 — Open benchmark framework for evaluating multi-agent systems. 🤝
