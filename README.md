...
| Set up evaluation infrastructure (119) | → [④ Toolchain](#-evaluation-toolchain) |
...
<details>
<summary>④ Evaluation Toolchain (119 resources)</summary>
...
- 🔧 🔷 [ax](https://github.com/Necmttn/ax) — Provides local observability for coding-agent sessions and costs.
