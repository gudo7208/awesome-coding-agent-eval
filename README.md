...
|---|---|---|---|---|---|---|
| [SWE-bench](https://github.com/swe-bench/SWE-bench) ✅ | 2294 real GitHub issues testing agent patch generation for Python bug fixes | python | 2294 | execution-based | 2023 | 5404 |
| [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ✅ | Benchmark agents on multimodal software engineering tasks | python | - | execution-based | 2024 | 5404 |
| [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ✅ | 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues | python | 500 | execution-based | 2023 | 5404 |
| [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ✅ | Benchmark code generation with continuously updated problems | python, cpp, java | - | execution-based | 2024 | 905 |
| [bigcodebench](https://github.com/bigcode-project/bigcodebench) ✅ | Benchmarks LLMs on complex function calls, tool use, and instruction following | python | 1140 | execution-based | 2024 | 514 |
| [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ✅ | Long-horizon SE task benchmark by Scale AI for multi-step complex engineering | python | - | execution-based | 2025 | 475 |
| [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ✅ | Benchmark reinforcement learning agents on terminal tasks | python | - | execution-based | 2025 | 394 |
| [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ✅ | Benchmark multi-language issue resolution extending SWE-bench | python | - | execution-based | 2025 | 352 |
| [joycode-agent](https://github.com/jd-opensource/joycode-agent) ✅ | Repository-level repair agent built and evaluated on SWE-Bench | python | 300 | execution-based | 2025 | 338 |
| [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ✅ | Evaluate agents on continuously updated real-world GitHub issues | python | - | execution-based | 2025 | 208 |
| [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ✅ | Benchmarks AI code generation across 13 programming languages | ruby | - | execution-based | 2026 | 161 |
...
| [skill](https://github.com/pinchbench/skill) ✅ | Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks | python | - | execution-based | 2026 | 1273 |
| [AICGSecEval](https://github.com/Tencent/AICGSecEval) ✅ | Evaluate security of AI-generated code | python | - | execution-based | 2025 | 646 |
| [appworld](https://github.com/StonyBrookNLP/appworld) ✅ | Evaluates agent tool-calling and planning across multi-app scenarios | python | - | execution-based | 2024 | 456 |
...
| [MARBLE](https://github.com/ulab-uiuc/MARBLE) ✅ | Benchmark multi-agent collaboration on software tasks | python | - | execution-based | 2025 | 277 |
...
| [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ✅ | Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning | - | 50 | execution-based | 2025 | 174 |
| [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ✅ | Benchmark autonomous agents in 1M-token real-world contexts with user simulation | python | - | execution-based | 2026 | 89 |
| [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ✅ | Benchmark LLM-generated tests for real-world software projects | python | 1983 | execution-based | 2024 | 85 |
