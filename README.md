...
|---|---|---|---|---|---|---|
| [SWE-bench](https://github.com/swe-bench/SWE-bench) ✅ | 2294 real GitHub issues testing agent patch generation for Python bug fixes | python | 2294 | execution-based | 2023 | 5006 |
| [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ✅ | SWE-bench Multimodal | python | - | execution-based | 2023 | 5006 |
| [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ✅ | 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues | python | 500 | execution-based | 2023 | 5006 |
| [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ✅ | LiveCodeBench | python, cpp, java | - | execution-based | 2024 | 872 |
...
| [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ✅ | Long-horizon SE task benchmark by Scale AI for multi-step complex engineering | python | - | execution-based | 2025 | 398 |
| [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ✅ | terminal-bench-rl | python | - | execution-based | 2025 | 385 |
| [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ✅ | multi-swe-bench | python | - | execution-based | 2025 | 334 |
| [joycode-agent](https://github.com/jd-opensource/joycode-agent) ✅ | Repository-level repair agent built and evaluated on SWE-Bench | python | 300 | execution-based | 2025 | 332 |
...
| [codefuse-evaluation](https://github.com/codefuse-ai/codefuse-evaluation) ✅ | codefuse-evaluation | python | - | execution-based | 2023 | 110 |
...
| [skill](https://github.com/pinchbench/skill) ✅ | Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks | python | - | execution-based | 2026 | 1196 |
| [AICGSecEval](https://github.com/Tencent/AICGSecEval) ✅ | AICGSecEval | python | - | execution-based | 2025 | 796 |
| [appworld](https://github.com/StonyBrookNLP/appworld) ✅ | Evaluates agent tool-calling and planning across multi-app scenarios | python | - | execution-based | 2024 | 423 |
...
| [MARBLE](https://github.com/ulab-uiuc/MARBLE) ✅ | MARBLE | python | - | execution-based | 2025 | 257 |
| [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ✅ | GitTaskBench | python | - | execution-based | 2025 | 255 |
| [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ✅ | Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning | - | 50 | execution-based | 2025 | 147 |
| [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ✅ | SWT-Bench | python | 1983 | execution-based | 2024 | 79 |
...
| [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) | Open benchmark framework for evaluating multi-agent systems | - | - | - | - | 6241 |
| [Github](https://github.com/openai/human-eval) | HumanEval: OpenAI benchmark for evaluating code generation from docstrings | - | - | - | - | 3240 |
