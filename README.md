...
|---|---|---|---|---|---|---|
| [SWE-bench](https://github.com/swe-bench/SWE-bench) ✅ | 2294 real GitHub issues testing agent patch generation for Python bug fixes | python | 2294 | execution-based | 2023 | 4895 |
| [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ✅ | SWE-bench Multimodal | python | - | execution-based | 2023 | 4895 |
| [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ✅ | 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues | python | 500 | execution-based | 2023 | 4895 |
| [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ✅ | LiveCodeBench | python, cpp, java | - | execution-based | 2024 | 860 |
...
| [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ✅ | terminal-bench-rl | python | - | execution-based | 2025 | 379 |
| [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ✅ | Long-horizon SE task benchmark by Scale AI for multi-step complex engineering | python | - | execution-based | 2025 | 377 |
...
| [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ✅ | SWE-bench-Live | python | - | execution-based | 2025 | 188 |
| [ai-coding-lang-bench](https://github.com/mame/ai-coding-lang-bench) ✅ | Benchmarks AI code generation across 13 programming languages | ruby | - | execution-based | 2026 | 155 |
...
| [skill](https://github.com/pinchbench/skill) ✅ | Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks | python | - | execution-based | 2026 | 1122 |
| [AICGSecEval](https://github.com/Tencent/AICGSecEval) ✅ | AICGSecEval | python | - | execution-based | 2025 | 971 |
| [appworld](https://github.com/StonyBrookNLP/appworld) ✅ | Evaluates agent tool-calling and planning across multi-app scenarios | python | - | execution-based | 2024 | 416 |
...
| [HackSynth](https://github.com/aielte-research/HackSynth) ✅ | Evaluates LLM agents on autonomous penetration testing via CTF challenges | python | - | execution-based | 2024 | 306 |
...
| [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ✅ | GitTaskBench | python | - | execution-based | 2025 | 254 |
| [MARBLE](https://github.com/ulab-uiuc/MARBLE) ✅ | MARBLE | python | - | execution-based | 2025 | 252 |
| [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ✅ | Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning | - | 50 | execution-based | 2025 | 141 |
...
| [open-multi-agent](https://github.com/JackChen-me/open-multi-agent) | Open benchmark framework for evaluating multi-agent systems | - | - | - | - | 6090 |
| [Github](https://github.com/openai/human-eval) | HumanEval: OpenAI benchmark for evaluating code generation from docstrings | - | - | - | - | 3223 |
