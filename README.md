...
|---|---|---|---|---|---|---|
| [SWE-bench](https://github.com/swe-bench/SWE-bench) ✅ | 2294 real GitHub issues testing agent patch generation for Python bug fixes | python | 2294 | execution-based | 2023 | 5058 |
| [SWE-bench Multimodal](https://github.com/swe-bench/SWE-bench) ✅ | Benchmark agents on multimodal software engineering tasks | python | - | execution-based | 2024 | 5058 |
| [SWE-bench Verified](https://github.com/swe-bench/SWE-bench) ✅ | 500 human-verified subset of SWE-bench filtering ambiguous or erroneous issues | python | 500 | execution-based | 2023 | 5058 |
| [LiveCodeBench](https://github.com/LiveCodeBench/LiveCodeBench) ✅ | Benchmark code generation with continuously updated problems | python, cpp, java | - | execution-based | 2024 | 876 |
| [bigcodebench](https://github.com/bigcode-project/bigcodebench) ✅ | Benchmarks LLMs on complex function calls, tool use, and instruction following | python | 1140 | execution-based | 2024 | 502 |
| [SWE-bench Pro](https://github.com/scaleapi/SWE-bench_Pro-os) ✅ | Long-horizon SE task benchmark by Scale AI for multi-step complex engineering | python | - | execution-based | 2025 | 412 |
| [terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) ✅ | Benchmark reinforcement learning agents on terminal tasks | python | - | execution-based | 2025 | 387 |
| [multi-swe-bench](https://github.com/multi-swe-bench/multi-swe-bench) ✅ | Benchmark multi-language issue resolution extending SWE-bench | python | - | execution-based | 2025 | 336 |
| [joycode-agent](https://github.com/jd-opensource/joycode-agent) ✅ | Repository-level repair agent built and evaluated on SWE-Bench | python | 300 | execution-based | 2025 | 334 |
| [SWE-bench-Live](https://github.com/microsoft/SWE-bench-Live) ✅ | Evaluate agents on continuously updated real-world GitHub issues | python | - | execution-based | 2025 | 193 |
...
| [skill](https://github.com/pinchbench/skill) ✅ | Benchmark by Kilo.ai for end-to-end evaluation of LLM coding agents on SE tasks | python | - | execution-based | 2026 | 1210 |
| [AICGSecEval](https://github.com/Tencent/AICGSecEval) ✅ | Evaluate security of AI-generated code | python | - | execution-based | 2025 | 794 |
| [appworld](https://github.com/StonyBrookNLP/appworld) ✅ | Evaluates agent tool-calling and planning across multi-app scenarios | python | - | execution-based | 2024 | 431 |
...
| [MARBLE](https://github.com/ulab-uiuc/MARBLE) ✅ | Benchmark multi-agent collaboration on software tasks | python | - | execution-based | 2025 | 259 |
| [GitTaskBench](https://github.com/QuantaAlpha/GitTaskBench) ✅ | Evaluate agents on Git-based software engineering tasks | python | - | execution-based | 2025 | 254 |
| [ai-agent-benchmark-compendium](https://github.com/philschmid/ai-agent-benchmark-compendium) ✅ | Curated index of 50+ AI agent benchmarks across coding, tool-use, and reasoning | - | 50 | execution-based | 2025 | 152 |
| [AgencyBench](https://github.com/GAIR-NLP/AgencyBench) ✅ | Benchmark autonomous agents in 1M-token real-world contexts with user simulation | python | - | execution-based | 2026 | 85 |
| [SWT-Bench](https://github.com/logic-star-ai/SWT-Bench) ✅ | Benchmark LLM-generated tests for real-world software projects | python | 1983 | execution-based | 2024 | 81 |
